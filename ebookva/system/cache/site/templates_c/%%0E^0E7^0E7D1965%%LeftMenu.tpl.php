<?php /* Smarty version 2.6.21, created on 2009-03-28 00:36:48
...
<?php echo $smarty->_tpl_vars['category']['alias']; ?>
"><?php echo $smarty->_tpl_vars['category']['title']; ?>
</a></li>
		<?php else: ?>
...
"><?php echo $smarty->_tpl_vars['category']['title']; ?>
		...
		<?php if (! empty ( $smarty->_tpl_vars['category']['childs'] )): ?>
			<ul><?php smarty_fun_cattree($smarty, array('list'=>$smarty->_tpl_vars['category']['childs']));  ?></ul>
		<?php endif; ?>
