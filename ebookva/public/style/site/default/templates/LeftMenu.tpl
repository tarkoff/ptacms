...
-->
<script src="{$smarty.const.JQUERYURL}/test.js" type="text/javascript" />

<div id="left">
	<a href="index.html">
		<img src="images/logo.gif" alt="pot" width="149" height="106" class="logo" title="pot" /> LOGO LOGO lOGO
	</a>
	<h2 class="menuTitle">More Links</h2>
	<ul class="lftNav">
