...
--
-- Definition of table `GELEZKA`.`BRANDS`
--

DROP TABLE IF EXISTS `GELEZKA`.`BRANDS`;
CREATE TABLE  `GELEZKA`.`BRANDS` (
...
--
-- Definition of table `GELEZKA`.`CATEGORIES`
--
...
--
-- Definition of table `GELEZKA`.`CATEGORIESFIELDS`
--
...
--
-- Definition of table `GELEZKA`.`MENUS`
--

DROP TABLE IF EXISTS `GELEZKA`.`MENUS`;
CREATE TABLE  `GELEZKA`.`MENUS` (
...
--
-- Definition of table `GELEZKA`.`PRODUCTS`
--
...
--
-- Definition of table `GELEZKA`.`PRODUCTSFIELDS`
--
...
--
-- Definition of table `GELEZKA`.`PRODUCTSSTAT`
--
...
--
-- Definition of table `GELEZKA`.`PRODUCTSVALUES`
--
...
--
-- Definition of table `GELEZKA`.`SQLLOG`
--
...
--
-- Definition of table `GELEZKA`.`USERGROUPS`
--
...
--
-- Dumping data for table `GELEZKA`.`USERGROUPS`
--

/*!40000 ALTER TABLE `USERGROUPS` DISABLE KEYS */;
INSERT INTO `GELEZKA`.`USERGROUPS` (`USERGROUPS_ID`,`USERGROUPS_NAME`) VALUES 
 (1,'Admins'),
 (2,'Mamagers');
...
--
-- Definition of table `GELEZKA`.`USERS`
--
...
--
-- Dumping data for table `GELEZKA`.`USERS`
--

/*!40000 ALTER TABLE `USERS` DISABLE KEYS */;
INSERT INTO `GELEZKA`.`USERS` (`USERS_ID`,`USERS_GROUPID`,`USERS_LOGIN`,`USERS_PASSWORD`,`USERS_REGISTERDATE`) VALUES 
 (1,1,'admin','037f85b5bc3bd0ec6efb1357eb5bc238','2009-03-14 15:45:15');
/*!40000 ALTER TABLE `USERS` ENABLE KEYS */;


--
-- Definition of table `GELEZKA`.`USERSTAT`
--
