...
INSERT INTO `EBOOKVA`.`CATEGORIES` VALUES  (1,0,'PaperBooks','Ð‘ÑƒÐ¼Ð°Ð¶Ð½Ñ‹Ðµ ÐºÐ½Ð¸Ð³Ð¸',1),
...
INSERT INTO `EBOOKVA`.`CATEGORIESFIELDS` VALUES  (1,1,3,10),
 (2,1,4,120),
 (3,2,3,100),
 (4,2,5,110),
 (5,2,3,120);
...
INSERT INTO `EBOOKVA`.`PRODUCTS` VALUES  (1,10,NULL,'','C++','',NULL,'2009-03-29 22:51:40','http://example.com'),
...
DROP TABLE IF EXISTS `EBOOKVA`.`PRODUCTSSTAT`;
CREATE TABLE  `EBOOKVA`.`PRODUCTSSTAT` (
...
INSERT INTO `EBOOKVA`.`PRODUCTSVALUES` VALUES  (5,5,3,'TarAS pAVUK'),
 (6,5,4,'2009');
...
INSERT INTO `EBOOKVA`.`USERGROUPS` VALUES  (1,'Admins'),
 (2,'Mamagers');
...
INSERT INTO `EBOOKVA`.`USERS` VALUES  (1,1,'admin','037f85b5bc3bd0ec6efb1357eb5bc238','2009-03-14 15:45:15');
...
INSERT INTO `EBOOKVA`.`USERSTAT` VALUES  (1,1,'2009-04-11 19:29:35','2009-04-11 19:29:35','c6cc642354c5591964313c0eeddd876b');
