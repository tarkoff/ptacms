...
<div id="footer">
	...
	<p class="t-center">
		...
		<span id="copy">
			...
			<span class="smaller">Visit <noindex><a target="_blank" rel=”nofollow” href="http://www.southpadre.net/" title="South Padre Island">South Padre Island</a></noindex></span>
		</span>
	</p>
	...
	<div id="counters" class="t-center f-right">
		...
		<div class="col120 noprint ">
			{literal}
				...
				<script type="text/javascript" language="javascript"><!--
					bmN=navigator,bmD=document,bmD.cookie='b=b',i=0,bs=[],bm={o:1,v:16828507,s:16828507,t:0,c:bmD.cookie?1:0,n:Math.round((Math.random()* 1000000)),w:0};
