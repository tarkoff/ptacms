...
class Catalog_PricesController extends KIT_Controller_Action_Backend_Abstract
{
	...
	public function listAction()
	{
		...
		if ($this->getRequest()->isXmlHttpRequest()) {
			$this->_helper->json($this->_getAjaxView($pricesTable));
		} else {
	...
	public function editAction()
	{
		...
		if (empty($id) && !$isAjax) {
			$this->_redirect('catalog/prices/add');
		}
	...
	public function deleteAction()
	{
		$this->_delete(
			...
			KIT_Db_Table_Abstract::get('KIT_Catalog_DbTable_Price')
		);
	}
}
