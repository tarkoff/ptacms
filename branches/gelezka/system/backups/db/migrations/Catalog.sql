...
-- 16-10-2009
alter table CATALOG_PRODUCTSFIELDS add PRODUCTSFIELDS_AUTOCOMPLETE tinyint(1) unsigned not null default 0;
alter table CATALOG_FILTERFIELDS add FILTERFIELD_FIELDTYPE tinyint unsigned not null default 1,
	add FILTERFIELD_SORTORDER int unsigned not null default 0,
	add FILTERFIELD_AUTOCOMPLETE tinyint(1) unsigned not null default 0;

-- 24-10-2009
-- ALTER TABLE CATALOG_CURRENCY ADD CURRENCY_ALIAS CHAR(8) NOT NULL DEFAULT '' AFTER CURRENCY_ID, ADD CURRENCY_RATE FLOAT(5,2) DEFAULT 0;
