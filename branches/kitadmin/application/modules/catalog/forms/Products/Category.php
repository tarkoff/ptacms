 ...
 * @version    $Id: Category.php 304 2010-04-19 19:07:18Z TPavuk $
 */

class Catalog_Form_Products_Category extends KIT_Form_Abstract
{
	/**
	...
	{
		$id = intval($id);
		$this->_model = KIT_Model_Abstract::get('KIT_Catalog_Category', $id);
		...
		if (!empty($id)) {
			...
			$this->setLegend($this->_model->getTitle() . ' - Product Category Edit Form');
		} else {
			$submit->setLabel('Add');
			$this->setLegend('Product Category Add Form');
		}
	}
